...
from koko_pi_agent.context import (
...
from koko_pi_agent.runtime.model_stream import StreamCollector
...
class Agent:
    def __init__(
        ...
        if memory_manager is not None:
            from koko_pi_agent.memory.consolidation import MemoryConsolidator
    ...
    def _get_plan_path(self) -> Path:
        ...
        plans_dir = Path(self.work_dir) / ".koko" / "plans"
