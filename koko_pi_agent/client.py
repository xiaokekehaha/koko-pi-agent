...
from koko_pi_agent.conversation_pairing import ensure_tool_pairing
from koko_pi_agent.serialization import (
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .koko/config.yaml or via ANTHROPIC_API_KEY env var."
            )
    ...
    def __init__(self, config: ProviderConfig) -> None:
        ...
        if not api_key:
            raise AuthenticationError(
                ...
                "Set it in .koko/config.yaml or via OPENAI_API_KEY env var."
            )
