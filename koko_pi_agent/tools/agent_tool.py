...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from koko_pi_agent.agents.fork import ForkError, build_forked_messages
        from koko_pi_agent.agents.parser import AgentDef
        from koko_pi_agent.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from koko_pi_agent.agent import Agent as AgentClass
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from koko_pi_agent.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        from koko_pi_agent.teams.spawn import build_teammate_cli
        ...
        if mailbox is not None and p.prompt:
            ...
            from koko_pi_agent.teams.spawn_inprocess import LEAD_NAME
            mailbox.write(
                teammate_name,
                create_message(
        ...
        try:
            if backend == BackendType.TMUX:
                from koko_pi_agent.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from koko_pi_agent.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from koko_pi_agent.worktree.integration import (
