...
def _create_builtin_tool(
    ...
    if name == "InstallSkill":
        ...
        return tool
    if name == "ToolSearch":
        from koko_pi_agent.tools.impl.tool_search import ToolSearchTool

        return ToolSearchTool(bindings.registry, protocol=bindings.protocol)
    if name == "AskUserQuestion":
        from koko_pi_agent.tools.ask_user import AskUserTool

        return AskUserTool()
    if name == "ExitPlanMode":
        from koko_pi_agent.tools.exit_plan_mode import ExitPlanModeTool
    ...
    if name == "EnterWorktree":
        from koko_pi_agent.tools.enter_worktree import EnterWorktreeTool
    ...
    if name == "ExitWorktree":
        from koko_pi_agent.tools.exit_worktree import ExitWorktreeTool
    ...
    if name == "Agent":
        from koko_pi_agent.tools.agent_tool import AgentTool
    ...
    if name == "TeamCreate":
        from koko_pi_agent.tools.team_create import TeamCreateTool
    ...
    if name == "TeamDelete":
        from koko_pi_agent.tools.team_delete import TeamDeleteTool
    ...
    if name == "SyntheticOutput":
        from koko_pi_agent.tools.synthetic_output import SyntheticOutputTool

        return SyntheticOutputTool(json_schema=bindings.synthetic_output_schema)
    if name == "TaskStop":
        from koko_pi_agent.tools.task_stop import TaskStopTool
