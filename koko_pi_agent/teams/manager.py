...
from koko_pi_agent.teams.backend_detect import BackendDetectionError, detect_backend
from koko_pi_agent.teams.mailbox import Mailbox, create_message
...
from koko_pi_agent.teams.shared_task import SharedTaskStore
from koko_pi_agent.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from koko_pi_agent.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
            elif backend_type == BackendType.ITERM2.value:
                from koko_pi_agent.teams.spawn_iterm2 import kill_pane
                kill_pane(pane_id)
