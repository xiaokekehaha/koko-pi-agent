...
from koko_pi_agent.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from koko_pi_agent.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from koko_pi_agent.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
